...
public class DatabaseOperations {
  ...
  protected static void insertIntoTables(Connection connection)
    ...
    try {
      ...
      statement.executeUpdate(
        "INSERT INTO Song (s_id, s_title, s_royalty_rate, s_royalty_paid_status, l_name, track_number, s_duration, s_release_date, s_country, s_language) VALUES \n" +
        " ('s1001', 'Electric Dreamscape', 0.1, FALSE, 'Electric Oasis', 6, '00:03:55', '2020-02-01', 'Canada', 'English'),\n" +
        " ('s1002', 'Midnight Mirage', 0.1, FALSE, 'Electric Oasis', 6, '00:03:55', '2020-02-10', 'Canada', 'English'),\n" +
        " ('s1003', 'Echoes of You', 0.1, FALSE, 'Lost in the Echoes', 7, '00:04:20', '2018-03-10', 'UK', 'English'),\n" +
        " ('s1004', 'Rainy Nights', 0.1, FALSE, 'Lost in the Echoes', 7, '00:04:20', '2019-03-10', 'UK', 'English');"
      );
    ...
    //   );
      ...
      statement.executeUpdate(
        "INSERT INTO listens_to_song (s_id, u_email_id, ls_date, ls_play_count) VALUES\n"+
        " ('s1001', 'u8001@example.com', '2023-01-01', 1),\n"+
        " ('s1001', 'u8002@example.com', '2023-01-01', 1),\n"+
        " ('s1001', 'u8001@example.com', '2023-01-10', 2),\n"+
        " ('s1001', 'u8001@example.com', '2023-01-12', 3),\n"+
        " ('s1001', 'u8001@example.com', '2023-01-13', 1),\n"+
        " ('s1001', 'u8002@example.com', '2023-01-30', 2),\n"+

        " ('s1001', 'u8001@example.com', '2023-02-02', 10),\n"+
        " ('s1001', 'u8002@example.com', '2023-02-25', 10),\n"+

        " ('s1001', 'u8001@example.com', '2023-03-10', 10),\n"+
        " ('s1001', 'u8002@example.com', '2023-03-11', 10),\n"+
        " ('s1001', 'u8001@example.com', '2023-03-12', 10),\n"+

        " ('s1001', 'u8001@example.com', '2023-04-01', 100),\n"+
        " ('s1001', 'u8001@example.com', '2023-04-02', 100),\n"+
        " ('s1001', 'u8001@example.com', '2023-04-03', 100),\n"+
        " ('s1001', 'u8002@example.com', '2023-04-04', 100),\n"+
        " ('s1001', 'u8002@example.com', '2023-04-05', 100),\n"+

        " ('s1002', 'u8001@example.com', '2023-01-02', 10),\n"+
        " ('s1002', 'u8002@example.com', '2023-01-02', 10),\n"+
        " ('s1002', 'u8001@example.com', '2023-01-11', 20),\n"+
        " ('s1002', 'u8001@example.com', '2023-01-14', 30),\n"+
        " ('s1002', 'u8001@example.com', '2023-01-15', 10),\n"+
        " ('s1002', 'u8002@example.com', '2023-01-29', 20),\n"+

        " ('s1002', 'u8001@example.com', '2023-02-03', 100),\n"+
        " ('s1002', 'u8002@example.com', '2023-02-26', 100),\n"+

        " ('s1002', 'u8001@example.com', '2023-03-13', 100),\n"+
        " ('s1002', 'u8002@example.com', '2023-03-14', 100),\n"+
        " ('s1002', 'u8001@example.com', '2023-03-15', 100),\n"+

        " ('s1002', 'u8001@example.com', '2023-04-04', 200),\n"+
        " ('s1002', 'u8001@example.com', '2023-04-05', 200),\n"+
        " ('s1002', 'u8001@example.com', '2023-04-06', 200),\n"+
        " ('s1002', 'u8002@example.com', '2023-04-01', 200),\n"+
        " ('s1002', 'u8002@example.com', '2023-04-02', 200),\n"+

        " ('s1003', 'u8001@example.com', '2023-01-03', 100),\n"+
        " ('s1003', 'u8002@example.com', '2023-01-03', 100),\n"+
        " ('s1003', 'u8001@example.com', '2023-01-16', 200),\n"+
        " ('s1003', 'u8001@example.com', '2023-01-17', 300),\n"+
        " ('s1003', 'u8001@example.com', '2023-01-18', 100),\n"+
        " ('s1003', 'u8002@example.com', '2023-01-20', 200),\n"+

        " ('s1003', 'u8001@example.com', '2023-02-04', 1000),\n"+
        " ('s1003', 'u8002@example.com', '2023-02-27', 1000),\n"+

        " ('s1003', 'u8001@example.com', '2023-03-05', 1000),\n"+
        " ('s1003', 'u8002@example.com', '2023-03-06', 1000),\n"+
        " ('s1003', 'u8001@example.com', '2023-03-07', 1000),\n"+

        " ('s1003', 'u8001@example.com', '2023-04-01', 20),\n"+
        " ('s1003', 'u8001@example.com', '2023-04-02', 20),\n"+
        " ('s1003', 'u8001@example.com', '2023-04-03', 20),\n"+
        " ('s1003', 'u8002@example.com', '2023-04-04', 20),\n"+
        " ('s1003', 'u8002@example.com', '2023-04-05', 20),\n"+

        " ('s1004', 'u8001@example.com', '2023-01-01', 1000),\n"+
        " ('s1004', 'u8002@example.com', '2023-01-01', 1000),\n"+
        " ('s1004', 'u8001@example.com', '2023-01-10', 2000),\n"+
        " ('s1004', 'u8001@example.com', '2023-01-12', 3000),\n"+
        " ('s1004', 'u8001@example.com', '2023-01-13', 1000),\n"+
        " ('s1004', 'u8002@example.com', '2023-01-30', 2000),\n"+

        " ('s1004', 'u8001@example.com', '2023-02-02', 10000),\n"+
        " ('s1004', 'u8002@example.com', '2023-02-25', 10000),\n"+

        " ('s1004', 'u8001@example.com', '2023-03-10', 10000),\n"+
        " ('s1004', 'u8002@example.com', '2023-03-11', 10000),\n"+
        " ('s1004', 'u8001@example.com', '2023-03-12', 10000),\n"+

        " ('s1004', 'u8001@example.com', '2023-04-01', 20),\n"+
        " ('s1004', 'u8001@example.com', '2023-04-02', 20),\n"+
        " ('s1004', 'u8001@example.com', '2023-04-03', 20),\n"+
        " ('s1004', 'u8002@example.com', '2023-04-04', 20),\n"+
        " ('s1004', 'u8002@example.com', '2023-04-05', 20);"
      );
